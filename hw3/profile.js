...
//rules for input
var rule = "\nDisplay Name: Only letters and numbers, start with a letter\n"
rule += "PhoneNumber: XXX-XXX-XXXX\n";
rule += "Zipcode: XXXXX or XXXXX-XXXX\n";


window.onload = function(){
document.getElementById("btn_tomain").onclick = function(){
