...
/***/ function(module, exports) {
	...
	var update = function update(_ref, delta, canvas) {
	    ...
	    if (position[0] < 0) position[0] = position[0] % 800 + 800;
	    if (position[0] > 800) position[0] = position[0] % 800;
	    if (position[1] < 0) position[1] = position[1] % 800 + 800;
	    if (position[1] > 800) position[1] = position[1] % 800;
